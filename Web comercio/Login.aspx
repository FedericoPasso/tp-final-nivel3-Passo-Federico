<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Web_comercio.Login" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="display: flex;">
                            <div class="col-12">
                                ...
                                <asp:Button ID="btnIngresar" runat="server" Text="Ingresar" CssClass="btn btn-success fw-bold" OnClick="btnIngresar_Click" />
                            </div>
                        </div>
                        ...
                        <div class="row" style="display: flex; text-align: center;">
                            <div class="col-12">
                                <p class="d-inline" style="color: white;">¿No tenés una cuenta?</p>
                                <a href="Registro.aspx" class="d-inline">Registrate acá</a>
                            </div>
                        </div>
                    </div>
                </div>
