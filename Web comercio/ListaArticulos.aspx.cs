...
namespace Web_comercio
{
    public partial class ListaArticulos : System.Web.UI.Page
    {
        ...
        protected void txtFiltro_TextChanged(object sender, EventArgs e)
        {
            ...
            List<Articulo> listaFiltrada = lista.FindAll(x => x.Nombre.ToUpper().Contains(txtFiltro.Text.ToUpper()) || x.categoria.Descripcion.ToUpper().Contains(txtFiltro.Text.ToUpper()) || x.marca.Descripcion.ToUpper().Contains(txtFiltro.Text.ToUpper()));
        ...
        {
            Categoriadatos cateNeg = new Categoriadatos();
            MarcaDatos marcaNeg = new MarcaDatos();
