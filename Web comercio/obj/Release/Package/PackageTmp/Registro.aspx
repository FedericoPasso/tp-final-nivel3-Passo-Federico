        ...
        <div class="row">
            <div class="col-6">
                <div class="card" style="border: none; padding: 20px; border-radius: 10px; background-color: transparent;"">
                    <div class="card-body">
                        <h3 class="mb-3 fw-bold" style="border-bottom: 2px solid #00784B; padding-bottom: 8px;">Creá tu perfil</h3>
                        
                        <div class="mb-3">
                            <asp:Label Text="Correo electrónico" runat="server"  Font-Size="Larger" Font-Bold="true" />
